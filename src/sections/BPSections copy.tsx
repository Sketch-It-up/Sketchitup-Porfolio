...
const OKRFramework = () => {
  const services = [
    { icon: <Target size={20} />, text: "Framework Design: Custom OKR Development", color: "#FF5733" },
    { icon: <Settings size={20} />, text: "Implementation: System Setup and Team Training", color: "#33FF57" },
    { icon: <BarChart3 size={20} />, text: "Monitoring: Regular Review and Adjustment", color: "#3357FF" },
    { icon: <ClipboardList size={20} />, text: "KPI Development: Meaningful Metrics Alignment", color: "#FF33A1" },
  ];
        ...
        <div className="flex flex-col md:flex-row items-center gap-8">
          ...
          >
            <Image
              src={image3}
              alt="OKR Framework"
              className="w-[80%] max-w-[320px] rounded-lg shadow-md"
            />
          </motion.div>
        </div>
      </div>
...
const StartupServices = () => {
  const services = [
    { icon: <Rocket size={20} />, text: "Incubation: Guidance Through Early-Stage Growth", color: "#FF5733" },
    { icon: <FileText size={20} />, text: "Pitch Deck Creation: Compelling Investor Presentations", color: "#33FF57" },
    { icon: <Briefcase size={20} />, text: "Funding Strategy: Investment Planning and Preparation", color: "#3357FF" },
  ];
...
const FinancialServices = () => {
  const services = [
    { icon: <BarChart3 size={20} />, text: "Financial Modeling: Custom Models for Business Scenarios", color: "#FF5733" },
    { icon: <TrendingUp size={20} />, text: "Projections: Detailed Forecasting and Analysis", color: "#33FF57" },
    { icon: <Gauge size={20} />, text: "Performance Metrics: KPI Development and Tracking", color: "#3357FF" },
  ];
...
const BusinessPlanning = () => {
  const services = [
    { icon: <Users size={20} />, text: "B2B Strategy: Partnerships & Channel Optimization", color: "#FF5733" },
    { icon: <Briefcase size={20} />, text: "B2C Planning: Consumer Engagement & Retention", color: "#33FF57" },
    { icon: <ShoppingCart size={20} />, text: "D2C Implementation: Direct-to-Consumer Growth", color: "#3357FF" },
  ];
...
const GrowthStrategy = () => {
  const services = [
    { icon: <TrendingUp size={20} />, text: "Domestic Market Penetration", color: "#FF5733" },
    { icon: <Globe size={20} />, text: "International Expansion Planning", color: "#33FF57" },
    { icon: <BarChart size={20} />, text: "Market Entry Execution", color: "#3357FF" },
    { icon: <Shield size={20} />, text: "Competitive Positioning", color: "#FF33A1" },
  ];
        ...
        <div className="mt-10 flex flex-col-reverse md:flex-row items-center gap-8">
          ...
          >
            <Image
              src={image4}
              alt="Growth Strategy"
              className="w-[80%] max-w-[350px] rounded-lg shadow-md"
            />
          </motion.div>
        </div>
      </div>
