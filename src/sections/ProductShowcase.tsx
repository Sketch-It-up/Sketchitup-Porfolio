      ...
      <div className="container">
        <div className='max-w-[540px] mx-auto'>
          <div className='flex justify-center'>
            ...
            <h2 className='text-center text-3xl md:text-[54px] md:leading-[60px] font-bold tracking-tighter bg-gradient-to-b from-black to-[#001E80] text-transparent bg-clip-text'>A more effective way to Visualise places </h2>
        ...
        <div className='relative'>
          ...
          <Image src={myProduct} alt='image' className='' ></Image>
            ...
            <motion.img src={pyramidImage.src} alt='pryimg' 
              height={262}
              width={262}
          ...
          <motion.img src={tubeImage.src} alt='tubeimg'
            height={248}
            width={248}
